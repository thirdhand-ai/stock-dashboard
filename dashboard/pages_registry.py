...
from dashboard.views import alert_activity, alert_history, backtest_report, daily_digest_config, dividend_income, ops_overview, paper_portfolio, price_alert_config, real_holdings, research_center, strategy_lab, ticker_detail, volatility_alert_config, watchlist
...
NAV_STRUCTURE = {
    "Overview": [PAGE_WATCHLIST, PAGE_TICKER_DETAIL, PAGE_PAPER_PORTFOLIO, PAGE_REAL_HOLDINGS, PAGE_DIVIDEND_INCOME, PAGE_OPS_OVERVIEW],
