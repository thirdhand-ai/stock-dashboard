...
from dashboard.views import alert_history, backtest_report, ops_overview, paper_portfolio, price_alert_config, research_center, strategy_lab, ticker_detail, watchlist
...
NAV_STRUCTURE = {
    ...
    "Research": [PAGE_RESEARCH_CENTER, PAGE_BACKTEST, PAGE_ALERTS, PAGE_PRICE_ALERT_CONFIG, PAGE_STRATEGY_LAB],
}
